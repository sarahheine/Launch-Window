function [RA Dec Az h dist_km] = LunarAzEl(jd,Lat,Lon,Alt)
...
% the elevation angle)
% Updated on 1/9/2012 to allow julian date input instead of UTC
...
UTC = [num2str(year) '/' num2str(month) '/' num2str(day) ' ' num2str(hour) ':' num2str(minute) ':' num2str(second)];
